...
const AccordionItem = ({
  ...
  return (
    <div className={`accordion-item border-2 border-black rounded-lg ${isOpen ? 'active' : ''}`}>
        ...
        >
          ...
          {imageSrc && (
            <img
              ...
              onError={(e) => { e.target.onerror = null; e.target.src = 'https://placehold.co/32x32/cccccc/333333?text=IMG'; }} // Placeholder for broken image
            />
          )}
          {/* Accordion title */}
      ...
      <div
        ...
        className={`accordion-collapse transition-all duration-300 ease-in-out ${isOpen ? 'block' : 'hidden'}`}
        aria-labelledby={`Program${id}`}
      >
        <div className="accordion-body p-0 pt-0 px-4 pb-4">
          <p className="text-[#222] text-base font-light leading-normal m-0 mb-4">{description}</p>
          {exploreLink && (
            <a
              href={exploreLink}
...
export default function ProgramSection () {
  ...
  return (
    <div className="section-program max-w-[1140px] mx-auto my-24 flex flex-row items-center gap-8
      ...
      <div className="program-text
        ...
        <div className="program-subtitle mb-4">
          <p className="subtitle text-[#513B6A] text-sm font-medium leading-normal m-0
                        max-sm:text-base max-sm:text-center">OUR PROGRAM</p>
        </div>
        <div className="program-title mb-5 max-sm:mb-4">
          <h4 className="title text-[#222] text-4xl font-normal leading-normal m-0
                        max-sm:text-2xl max-sm:leading-7 max-sm:text-center">We Offer More Than Meets The Eye</h4>
        </div>
        <div className="program-description mb-8">
          <p className="description text-[#222] text-base font-light leading-normal m-0
                        max-sm:text-sm max-sm:text-center">As your go-to digital marketing partner to support your brand business, we manage to provide integrated programmes within the company to resonate our values externally, as we keep on spreading our wings to influence the industry.</p>
        </div>
        ...
        <div className="program-image block md:hidden flex-none w-full mb-8 overflow-hidden">
          <img
            ...
            onError={(e) => { e.target.onerror = null; e.target.src = 'https://placehold.co/510x300/cccccc/333333?text=Image'; }} // Placeholder for broken image
          />
        </div>
        {/* Accordion Section */}
      ...
      <div className="program-image hidden md:block relative flex-none w-[510px] overflow-hidden
                      md:w-[41.517vw]">
        <img
          decoding="async"
          src="https://bolehdicoba.com/wp-content/uploads/2024/06/Group-40343-8.png"
